               ...
               if(isset($_SESSION['username']))
                {
                   echo '<div class="float_left">
                        <p class="top_heading"><sapn id="top">WellCome</sapn</p>
                        </div>';
                }
                else
                {
                    ...
                    <div class="search_engine">
                        <div class="search_bar">
                            <div class="search_box">
                                ...
                                <button style="background:black; broder:0px;" type="submit" name="submit-search"><img src="magnifying-glass.png" alt="search-icon" height="25" width="25"></button>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="categories_section">
                            <div class="category-dropdown">
                                <select name="category">
                                    <option class="options" value="" selected>All Categories</option>
